        ...
        <div className="p-5 border-b border-zinc-200 dark:border-zinc-800 flex items-start justify-between gap-4 bg-zinc-50 dark:bg-zinc-950/80">
          <div className="space-y-1">
            <div className="flex items-center gap-2 flex-wrap text-xs">
              <span className="px-2.5 py-0.5 rounded bg-blue-500/10 text-blue-600 dark:text-blue-400 border border-blue-500/20 font-semibold uppercase tracking-wider text-[10px]">
                {item.category}
              </span>
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className={`p-2 rounded-xl transition-colors cursor-pointer ${
                isSaved
                  ...
                  : 'text-zinc-400 hover:bg-zinc-100 dark:hover:bg-zinc-800 text-zinc-600 dark:text-zinc-400 hover:text-zinc-900 dark:hover:text-zinc-100'
              }`}
            ...
            <a
              ...
              className="p-2 rounded-xl text-zinc-400 hover:text-blue-600 dark:hover:text-blue-400 hover:bg-zinc-100 dark:hover:bg-zinc-800 transition-colors"
        ...
        <div className="p-6 overflow-y-auto flex-1 space-y-6">
          {activeTab === 'summary' ? (
            <>
              ...
              <div className="bg-blue-50/50 dark:bg-blue-500/5 border border-blue-200 dark:border-blue-500/20 rounded-2xl p-5 space-y-3">
                <div className="flex items-center justify-between">
                  <h3 className="text-sm font-bold text-blue-600 dark:text-blue-400 flex items-center gap-2">
                    <Sparkles className="w-4 h-4 text-blue-600 dark:text-blue-400" />
                    Key Actionable Takeaways
                  </h3>
                  <span className="text-[10px] font-bold px-2 py-0.5 rounded bg-blue-500/20 text-blue-700 dark:text-blue-300 border border-blue-500/30">
                    AI Extracted
                  </span>
                </div>
                ...
                <ul className="space-y-2.5">
                  {item.keyTakeaways.map((takeaway, idx) => (
                    <li key={idx} className="flex items-start justify-between gap-3 bg-white dark:bg-zinc-950/80 p-3 rounded-xl border border-zinc-200 dark:border-zinc-800 text-xs text-zinc-800 dark:text-zinc-200 font-medium">
                      ...
                      >
                        {copiedTakeawayIndex === idx ? <Check className="w-3.5 h-3.5 text-emerald-500 dark:text-emerald-400" /> : <Copy className="w-3.5 h-3.5" />}
                      </button>
                    </li>
                  ))}
                </ul>
            ...
            <div className="flex flex-col h-full space-y-4">
              ...
              >
                <input
                  ...
                  className="flex-1 bg-zinc-100 dark:bg-zinc-800 text-xs px-3.5 py-2.5 rounded-xl border border-zinc-200 dark:border-zinc-700 text-zinc-900 dark:text-zinc-100 focus:outline-none focus:ring-2 focus:ring-blue-500 font-medium placeholder-zinc-400 dark:placeholder-zinc-500"
                />
                <button
                  type="submit"
