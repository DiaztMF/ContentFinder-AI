    ...
    <div className="w-full space-y-8">
              ...
              return (
                <button
                  ...
                  className={`w-full flex items-center justify-between p-3.5 rounded-2xl text-left border transition-all cursor-pointer ${
                    isSelected
                      ? 'bg-blue-500/10 border-blue-500/30 text-zinc-100 shadow-2xl'
                ...
                >
                  ...
                  <span className="px-2 py-0.5 rounded-full bg-zinc-800 text-[10px] font-bold text-zinc-400 border border-zinc-700/60">
                    {col.itemIds.length}
                  </span>
                </button>
              );
        ...
        <div className="lg:col-span-3 space-y-6">
          {selectedCollection ? (
            <div>
              ...
              <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-5 mb-6 shadow-2xl flex items-center justify-between gap-4">
                <div>
              ...
              {collectionContents.length > 0 ? (
                ...
                <div className="bg-zinc-900 border border-dashed border-zinc-800 rounded-2xl p-12 text-center space-y-3">
                  <div className="w-10 h-10 rounded-xl bg-zinc-800 text-zinc-400 mx-auto flex items-center justify-center border border-zinc-700">
            ...
            <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-12 text-center space-y-3">
              <p className="text-xs text-zinc-400">Select a collection on the left to view saved contents.</p>
            </div>
          )}
        </div>
      </div>
      ...
      {showCreateModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-in fade-in duration-200">
          <div className="relative w-full max-w-md bg-zinc-900 border border-zinc-800 rounded-2xl shadow-2xl p-6 space-y-5">
            ...
            <form onSubmit={handleCreateSubmit} className="space-y-4 text-xs">
              <div>
                ...
                <input
                  ...
                  className="w-full bg-zinc-800 border border-zinc-700 rounded-xl px-3.5 py-2.5 text-zinc-100 focus:outline-none focus:ring-2 focus:ring-blue-500 font-medium placeholder-zinc-500"
                />
              </div>
              ...
              <div className="flex items-center justify-end gap-3 pt-3 border-t border-zinc-800">
                <button
                  type="button"
                  onClick={() => setShowCreateModal(false)}
                  className="px-4 py-2 rounded-xl text-zinc-400 hover:bg-zinc-800 cursor-pointer"
                >
                  Cancel
                </button>
                <button
