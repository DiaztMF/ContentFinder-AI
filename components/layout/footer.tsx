...
export function Footer() {
  return (
    <footer className="w-full border-t border-zinc-200 dark:border-zinc-800 bg-white dark:bg-[#09090b] py-3.5 px-4 sm:px-8 transition-colors">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-3 text-[10px] text-zinc-500 dark:text-zinc-400 font-mono uppercase tracking-wider">
